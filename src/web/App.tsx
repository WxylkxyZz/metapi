          ...
          <div className="login-brand-header">
            <div className="brand-mark-frame brand-mark-frame-hero">
              <div className="brand-mark-canvas">
                <img src="/logo.png" alt="Canopy" className="login-brand-logo" />
              </div>
            </div>
            <div className="login-brand-summary">
              <div className="login-brand-name">Canopy</div>
    ...
    <>
      <header className="topbar">
        ...
        <div className="topbar-logo">
          <img src="/logo.png" alt="Canopy" style={{ width: 28, height: 28, borderRadius: 6 }} />
          <span className="topbar-logo-text">Canopy</span>
        </div>
